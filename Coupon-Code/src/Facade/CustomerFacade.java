...
public class CustomerFacade implements CouponClientFacade {
	...
	// public boolean login(String name, String password, ClientType cType) {
	...
	// if (customerLocaly.getCustomerName().equals(this.CUST_NAME) &&
	// customerLocaly.getPassword().equals(this.pass)
	// && customerLocaly != null) {
	////
	// return true;
